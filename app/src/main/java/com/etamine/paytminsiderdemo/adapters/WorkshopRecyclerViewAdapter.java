...
public class WorkshopRecyclerViewAdapter extends RecyclerView.Adapter<WorkshopRecyclerViewAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<MasterList> masterList;

    public WorkshopRecyclerViewAdapter(Context context, ArrayList<MasterList> masterList){
        this.context = context;
        this.masterList = masterList;
    }
    @NonNull
    @Override
    public WorkshopRecyclerViewAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull WorkshopRecyclerViewAdapter.MyViewHolder holder, int position) {
        MasterList currentData = masterList.get(position);

        if (currentData.getGroup_id().getName().equalsIgnoreCase("workshops")) {
