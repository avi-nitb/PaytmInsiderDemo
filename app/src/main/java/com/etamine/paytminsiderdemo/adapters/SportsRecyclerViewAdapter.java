...
public class SportsRecyclerViewAdapter extends RecyclerView.Adapter<SportsRecyclerViewAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<MasterList> masterList;

    public SportsRecyclerViewAdapter(Context context, ArrayList<MasterList> masterList){
        this.context = context;
        this.masterList = masterList;
    }
    @NonNull
    @Override
    public SportsRecyclerViewAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
